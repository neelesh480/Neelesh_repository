...
public class XmlToExcelConverter {
    ...
    private static void getAndReadXml() throws Exception 
    {
        ...
        File xmlFileUrl = new File("F:/movies/Publication1.xml");
        System.out.println("downloading file from " + xmlFileUrl + " ...");
        FileUtils.copyFile(xmlFileUrl, xmlFile);
        ...
        FileOutputStream fileOut = new FileOutputStream("E:/Song/Excel-Out.xml");
